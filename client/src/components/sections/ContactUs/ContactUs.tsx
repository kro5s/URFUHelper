    ...
    return (
        <section className="py-20 md:py-28 text-center">
            <div className="my-container">
                ...
                <div className="mt-4"><span className="font-medium text-xl"><FormattedMessage
                    id="found_translation_issues"/></span></div>
                <div
                    className="flex items-center justify-between gap-x-20 max-w-[970px] bg-primary-black rounded-[30px] p-16 mx-auto mt-10 flex-col md:flex-row">
                    <form className="text-left text-white">
                        <div className="flex justify-between gap-x-8 flex-col md:flex-row">
                            <div>
                                <div className="mb-2"><label htmlFor="contactusname"><FormattedMessage
                                    id="name"/></label></div>
                            ...
                            <div>
                                <div className="mb-2 mt-4 md:mt-0"><label htmlFor="contactusemail"><FormattedMessage
                                    id="email"/></label></div>
                        ...
                        <div className="mb-2 mt-4"><label htmlFor="contactusmessage"><FormattedMessage
                            id="message"/></label></div>
                    ...
                    <svg className="hidden md:block" width="283" height="283" viewBox="0 0 283 283" fill="none"
