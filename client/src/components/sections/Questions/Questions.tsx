...
const Questions = () => {
    return (
        <section className="bg-primary-black py-28 text-white text-center">
            <h2 className="text-4xl font-semibold">Popular questions</h2>
            <div className="flex flex-col max-w-[970px] my-20 mx-auto gap-y-8">
                <Question question="Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?"
                          answer="Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?"/>
                <Question question="Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?"
                          answer="Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?"/>
                <Question question="Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?"
                          answer="Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?Lorem ipsum dolor sit amet consectetur. Sit a in vel nunc elit convallis pretium?"/>
            ...
            <Button link="/" type={ButtonTypes.ACCENT}>Other questions</Button>
        </section>
    );
};
...
const Question: React.FC<{ question: string; answer: string }> = ({question, answer}) => {
    ...
    return (
        <div onClick={handleAnswerOpen} className="text-left cursor-pointer pb-6 border-b border-white/[0.2]">
