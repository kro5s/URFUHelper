...
const Community: React.FC<{country: string; vkLink: string; flag: string, img: string}> = ({ country, vkLink, flag, img }) => {
    return (
        <a href={vkLink} target="_blank">
            <div
                className="flex flex-col h-full items-center justify-between w-[200px] gap-y-6 border border-black/[0.2] rounded-3xl py-6 px-10 hover:border-accent transition">
